        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              SizedBox(height: 20,),
              Padding(padding: EdgeInsets.only(left: 3,bottom: 15),child: Text("Hi,Netsoft-Developer",
              style: TextStyle(color: Colors.white,letterSpacing: 1,wordSpacing: 2,fontWeight:
              FontWeight.w600,
              fontSize: 25),),),
                Container(
          ...
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                ...
                Text("See All",style: TextStyle(fontSize: 23,fontWeight: FontWeight.w500,color: Color(0xFF674AEF)),),
              ],
            ),
